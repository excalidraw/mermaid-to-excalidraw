...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/mermaid/dist/stateDiagram-v2-9765461d.js":[function(require,module,exports) {
"use strict";
...
const getClasses = function (text, diagramObj) {
  _commonDb573409be.l.trace("Extracting classes");
  diagramObj.db.clear();
  try {
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.type !== _styles47a825a.a) {
    ...
    if (!nodeDb[itemId]) {
      nodeDb[itemId] = {
        id: itemId,
        shape,
        description: _commonDb573409be.e.sanitizeText(itemId, (0, _commonDb573409be.g)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _commonDb573409be.e.sanitizeTextOrArray(newNode.description, (0, _commonDb573409be.g)());
    }
    if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
      newNode.shape = SHAPE_STATE;
    }
    if (!newNode.type && parsedItem.doc) {
      _commonDb573409be.l.info("Setting cluster for ", itemId, getDir(parsedItem));
      newNode.type = "group";
      newNode.dir = getDir(parsedItem);
      newNode.shape = parsedItem.type === _styles47a825a.b ? SHAPE_DIVIDER : SHAPE_GROUP;
  ...
  if (parent && parent.id !== "root") {
    _commonDb573409be.l.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    g.setParent(itemId, parent.id);
  }
  if (parsedItem.doc) {
    _commonDb573409be.l.trace("Adding nodes children ");
    setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
  }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag) => {
  _commonDb573409be.l.trace("items", doc);
  doc.forEach(item => {
    switch (item.stmt) {
      case _styles47a825a.c:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles47a825a.a:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles47a825a.S:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _commonDb573409be.e.sanitizeText(item.description, (0, _commonDb573409be.g)()),
            arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
            labelpos: G_EDGE_LABELPOS,
            labelType: G_EDGE_LABELTYPE,
            thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = _styles47a825a.e) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
const draw = function (text, id, _version, diag) {
  _commonDb573409be.l.info("Drawing state diagram (v2)", id);
  nodeDb = {};
  let dir = diag.db.getDirection();
  if (dir === void 0) {
    dir = _styles47a825a.D;
  }
  const {
    securityLevel,
    state: conf
  ...
  _commonDb573409be.l.info(diag.db.getRootDocV2());
  ...
  (0, _index5219d.r)(element, g, ["barb"], CSS_DIAGRAM, id);
  const padding = 8;
  _utilsD622194a.u.insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
...
//# sourceMappingURL=/stateDiagram-v2-9765461d.461649af.js.map