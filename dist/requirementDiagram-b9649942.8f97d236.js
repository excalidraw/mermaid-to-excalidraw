...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/mermaid/dist/requirementDiagram-b9649942.js":[function(require,module,exports) {
"use strict";
...
const addElement = name => {
  if (elements[name] === void 0) {
    ...
    _commonDb573409be.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const db = {
  ...
  Relationships,
  parseDirective,
  getConfig: () => (0, _commonDb573409be.g)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
const drawRelationshipFromLayout = function (svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr("marker-start", "url(" + _commonDb573409be.e.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)");
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr("marker-end", "url(" + _commonDb573409be.e.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)");
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach(reqName => {
    ...
    _commonDb573409be.l.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = (0, _commonDb573409be.g)().requirement;
  diagObj.db.clear();
...
//# sourceMappingURL=/requirementDiagram-b9649942.8f97d236.js.map