...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/dayjs/plugin/isoWeek.js":[function(require,module,exports) {
var define;
...
},{}],"node_modules/dayjs/plugin/advancedFormat.js":[function(require,module,exports) {
var define;
...
},{}],"node_modules/mermaid/dist/ganttDiagram-04e74c0a.js":[function(require,module,exports) {
"use strict";
...
const getStartDate = function (prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _commonDb573409be.l.debug("Invalid date:" + str);
    _commonDb573409be.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function (ids, _linkStr) {
  ...
  if ((0, _commonDb573409be.g)().securityLevel !== "loose") {
    linkStr = (0, _sanitizeUrl.sanitizeUrl)(_linkStr);
  }
...
const setClickFun = function (id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _utilsD622194a.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  parseDirective,
  getConfig: () => (0, _commonDb573409be.g)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
...
const setConf = function () {
  _commonDb573409be.l.debug("Something is calling, setConf, remove the call");
};
...
const draw = function (text, id, version, diagObj) {
  const conf = (0, _commonDb573409be.g)().gantt;
  ...
  const timeScale = (0, _d.scaleTime)().domain([(0, _d.min)(taskArray, function (d) {
    return d.startTime;
  }), (0, _d.max)(taskArray, function (d) {
    return d.endTime;
  ...
  (0, _utilsD622194a.k)(svg, h, w, conf.useMaxWidth);
  ...
  function makeGant(tasks2, pageWidth, pageHeight) {
    ...
    const colorScale = (0, _d.scaleLinear)().domain([0, categories.length]).range(["#00B9FA", "#F95002"]).interpolate(_d.interpolateHcl);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0, _commonDb573409be.g)().securityLevel;
    if (securityLevel2 === "sandbox") {
      let sandboxElement2;
      sandboxElement2 = (0, _d.select)("#i" + id);
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    let bottomXAxis = (0, _d.axisBottom)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0, _d.timeFormat)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        case "minute":
          bottomXAxis.ticks(_d.timeMinute.every(every));
          break;
        case "hour":
          bottomXAxis.ticks(_d.timeHour.every(every));
          break;
        case "day":
          bottomXAxis.ticks(_d.timeDay.every(every));
          break;
        case "week":
          bottomXAxis.ticks(_d.timeWeek.every(every));
          break;
        case "month":
          bottomXAxis.ticks(_d.timeMonth.every(every));
          break;
      }
    }
    svg.append("g").attr("class", "grid").attr("transform", "translate(" + theSidePad + ", " + (h2 - 50) + ")").call(bottomXAxis).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em");
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      let topXAxis = (0, _d.axisTop)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0, _d.timeFormat)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
      if (resultTickInterval !== null) {
        const every = resultTickInterval[1];
        const interval = resultTickInterval[2];
        switch (interval) {
          case "minute":
            topXAxis.ticks(_d.timeMinute.every(every));
            break;
          case "hour":
            topXAxis.ticks(_d.timeHour.every(every));
            break;
          case "day":
            topXAxis.ticks(_d.timeDay.every(every));
            break;
          case "week":
            topXAxis.ticks(_d.timeWeek.every(every));
            break;
          case "month":
            topXAxis.ticks(_d.timeMonth.every(every));
            break;
        }
      }
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurances).enter().append(function (d) {
      const rows = d[0].split(_commonDb573409be.e.lineBreakRegex);
...
},{"@braintree/sanitize-url":"node_modules/@braintree/sanitize-url/dist/index.js","dayjs":"node_modules/dayjs/dayjs.min.js","dayjs/plugin/isoWeek.js":"node_modules/dayjs/plugin/isoWeek.js","dayjs/plugin/customParseFormat.js":"node_modules/dayjs/plugin/customParseFormat.js","dayjs/plugin/advancedFormat.js":"node_modules/dayjs/plugin/advancedFormat.js","./commonDb-573409be.js":"node_modules/mermaid/dist/commonDb-573409be.js","./utils-d622194a.js":"node_modules/mermaid/dist/utils-d622194a.js","./mermaidAPI-3ae0f2f0.js":"node_modules/mermaid/dist/mermaidAPI-3ae0f2f0.js","d3":"node_modules/d3/src/index.js","dompurify":"node_modules/dompurify/dist/purify.js","khroma":"node_modules/khroma/dist/index.js","lodash-es/memoize.js":"node_modules/lodash-es/memoize.js","stylis":"node_modules/stylis/dist/stylis.mjs","lodash-es/isEmpty.js":"node_modules/lodash-es/isEmpty.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/ganttDiagram-04e74c0a.0be8e91d.js.map