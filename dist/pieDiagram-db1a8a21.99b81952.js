...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/mermaid/dist/pieDiagram-db1a8a21.js":[function(require,module,exports) {
"use strict";
...
const addSection = function (id, value) {
  ...
  if (sections[id] === void 0) {
    sections[id] = value;
    _commonDb573409be.l.debug("Added new section :", id);
  }
};
...
const db = {
  parseDirective,
  getConfig: () => (0, _commonDb573409be.g)().pie,
  addSection,
  getSections,
  cleanupValue,
  clear,
...
let conf = (0, _commonDb573409be.g)();
let width;
const height = 450;
const draw = (txt, id, _version, diagObj) => {
  var _a;
  try {
    conf = (0, _commonDb573409be.g)();
    _commonDb573409be.l.debug("Rendering info diagram\n" + txt);
    ...
    _commonDb573409be.l.debug("Parsed info diagram");
    ...
    (0, _utilsD622194a.k)(diagram2, height, width, conf.pie.useMaxWidth);
    ...
    let [outerStrokeWidth] = (0, _utilsD622194a.x)(themeVariables.pieOuterStrokeWidth);
    outerStrokeWidth ?? (outerStrokeWidth = 2);
    var color = (0, _d.scaleOrdinal)().range(myGeneratedColors);
    ...
    var pie$1 = (0, _d.pie)().value(function (d) {
      return d.value;
    }).sort(function (a, b) {
      return a.order - b.order;
    });
    var dataReady = pie$1(pieData);
    var arcGenerator = (0, _d.arc)().innerRadius(0).outerRadius(radius);
    var labelArcGenerator = (0, _d.arc)().innerRadius(radius * textPosition).outerRadius(radius * textPosition);
    ...
    _commonDb573409be.l.error("Error while rendering info diagram");
...
//# sourceMappingURL=/pieDiagram-db1a8a21.99b81952.js.map