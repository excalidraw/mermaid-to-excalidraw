...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/mermaid/dist/gitGraphDiagram-0a645df6.js":[function(require,module,exports) {
"use strict";
...
let mainBranchName = (0, _commonDb573409be.g)().gitGraph.mainBranchName;
let mainBranchOrder = (0, _commonDb573409be.g)().gitGraph.mainBranchOrder;
let commits = {};
let head = null;
let branchesConfig = {};
...
const setOptions = function (rawOptString) {
  _commonDb573409be.l.debug("options str", rawOptString);
  rawOptString = rawOptString && rawOptString.trim();
  rawOptString = rawOptString || "{}";
  try {
    options = JSON.parse(rawOptString);
  } catch (e) {
    _commonDb573409be.l.error("error while parsing gitGraph options", e.message);
  }
};
...
const commit = function (msg, id, type, tag) {
  _commonDb573409be.l.debug("Entering commit:", msg, id, type, tag);
  id = _commonDb573409be.e.sanitizeText(id, (0, _commonDb573409be.g)());
  msg = _commonDb573409be.e.sanitizeText(msg, (0, _commonDb573409be.g)());
  tag = _commonDb573409be.e.sanitizeText(tag, (0, _commonDb573409be.g)());
  const commit2 = {
    id: id ? id : seq + "-" + getId(),
    message: msg,
    seq: seq++,
  ...
  _commonDb573409be.l.debug("in pushCommit " + commit2.id);
};
const branch = function (name, order) {
  name = _commonDb573409be.e.sanitizeText(name, (0, _commonDb573409be.g)());
  if (branches[name] === void 0) {
    ...
    checkout(name);
    _commonDb573409be.l.debug("in createBranch");
  } else {
...
const merge = function (otherBranch, custom_id, override_type, custom_tag) {
  otherBranch = _commonDb573409be.e.sanitizeText(otherBranch, (0, _commonDb573409be.g)());
  custom_id = _commonDb573409be.e.sanitizeText(custom_id, (0, _commonDb573409be.g)());
  ...
  commits[commit2.id] = commit2;
  branches[curBranch] = commit2.id;
  _commonDb573409be.l.debug(branches);
  _commonDb573409be.l.debug("in mergeBranch");
};
const cherryPick = function (sourceId, targetId, tag) {
  _commonDb573409be.l.debug("Entering cherryPick:", sourceId, targetId, tag);
  sourceId = _commonDb573409be.e.sanitizeText(sourceId, (0, _commonDb573409be.g)());
  targetId = _commonDb573409be.e.sanitizeText(targetId, (0, _commonDb573409be.g)());
  tag = _commonDb573409be.e.sanitizeText(tag, (0, _commonDb573409be.g)());
  ...
  if (!targetId || commits[targetId] === void 0) {
    ...
    branches[curBranch] = commit2.id;
    _commonDb573409be.l.debug(branches);
    _commonDb573409be.l.debug("in cherryPick");
  }
};
const checkout = function (branch2) {
  branch2 = _commonDb573409be.e.sanitizeText(branch2, (0, _commonDb573409be.g)());
...
function prettyPrintCommitHistory(commitArr) {
  ...
  _commonDb573409be.l.debug(label.join(" "));
...
const prettyPrint = function () {
  _commonDb573409be.l.debug(commits);
...
const clear$1 = function () {
  commits = {};
  head = null;
  let mainBranch = (0, _commonDb573409be.g)().gitGraph.mainBranchName;
  let mainBranchOrder2 = (0, _commonDb573409be.g)().gitGraph.mainBranchOrder;
  branches = {};
...
const getCommitsArray = function () {
  ...
  commitArr.forEach(function (o) {
    _commonDb573409be.l.debug(o.id);
  });
...
const gitGraphDb = {
  parseDirective,
  getConfig: () => (0, _commonDb573409be.g)().gitGraph,
  setDirection,
  setOptions,
  getOptions,
  commit,
...
const drawCommits = (svg, commits2, modifyGraph) => {
  const gitGraphConfig = (0, _utilsD622194a.t)().gitGraph;
...
const draw = function (txt, id, ver, diagObj) {
  clear();
  const conf = (0, _utilsD622194a.t)();
  const gitGraphConfig = conf.gitGraph;
  _commonDb573409be.l.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  ...
  const diagram2 = (0, _d.select)(`[id="${id}"]`);
  ...
  _utilsD622194a.u.insertTitle(diagram2, "gitTitleText", gitGraphConfig.titleTopMargin, diagObj.db.getDiagramTitle());
  (0, _utilsD622194a.v)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth ?? conf.useMaxWidth);
};
...
//# sourceMappingURL=/gitGraphDiagram-0a645df6.3eef0415.js.map