...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/mermaid/dist/c4Diagram-44c43e89.js":[function(require,module,exports) {
"use strict";
...
const setC4Type = function (c4TypeParam) {
  let sanitizedText = (0, _commonDb573409be.b)(c4TypeParam, (0, _commonDb573409be.g)());
...
const setTitle = function (txt) {
  let sanitizedText = (0, _commonDb573409be.b)(txt, (0, _commonDb573409be.g)());
  title = sanitizedText;
};
const c4Db = {
  addPersonOrSystem,
  ...
  parseDirective,
  getConfig: () => (0, _commonDb573409be.g)().c4,
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
  if (!c4Shape[textType].width) {
    if (c4ShapeTextWrap) {
      c4Shape[textType].text = (0, _utilsD622194a.w)(c4Shape[textType].text, textLimitWidth, textConf);
      c4Shape[textType].textLines = c4Shape[textType].text.split(_commonDb573409be.e.lineBreakRegex).length;
      c4Shape[textType].width = textLimitWidth;
      c4Shape[textType].height = (0, _utilsD622194a.m)(c4Shape[textType].text, textConf);
    } else {
      let lines = c4Shape[textType].text.split(_commonDb573409be.e.lineBreakRegex);
      c4Shape[textType].textLines = lines.length;
      let lineHeight = 0;
      c4Shape[textType].height = 0;
      c4Shape[textType].width = 0;
      for (const line of lines) {
        c4Shape[textType].width = Math.max((0, _utilsD622194a.j)(line, textConf), c4Shape[textType].width);
        lineHeight = (0, _utilsD622194a.m)(line, textConf);
...
const drawBoundary = function (diagram2, boundary, bounds) {
  ...
  let textLimitWidth = (0, _utilsD622194a.j)(boundary.label.text, boundaryLabelConf);
...
const drawC4ShapeArray = function (currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
  ...
  for (const c4ShapeKey of c4ShapeKeys) {
    ...
    c4Shape.typeC4Shape.width = (0, _utilsD622194a.j)("<<" + c4Shape.typeC4Shape.text + ">>", c4ShapeTypeConf);
...
const drawRels = function (diagram2, rels2, getC4ShapeObj, diagObj) {
  ...
  for (let rel of rels2) {
    ...
    let textLimitWidth = (0, _utilsD622194a.j)(rel.label.text, relConf);
    calcC4ShapeTextWH("label", rel, relTextWrap, relConf, textLimitWidth);
    if (rel.techn && rel.techn.text !== "") {
      textLimitWidth = (0, _utilsD622194a.j)(rel.techn.text, relConf);
      calcC4ShapeTextWH("techn", rel, relTextWrap, relConf, textLimitWidth);
    }
    if (rel.descr && rel.descr.text !== "") {
      textLimitWidth = (0, _utilsD622194a.j)(rel.descr.text, relConf);
...
const draw = function (_text, id, _version, diagObj) {
  ...
  _commonDb573409be.l.debug(`C:${JSON.stringify(conf, null, 2)}`);
  ...
  _commonDb573409be.l.debug(`models:`, box);
};
const c4Renderer = {
...
},{"./mermaidAPI-3ae0f2f0.js":"node_modules/mermaid/dist/mermaidAPI-3ae0f2f0.js","./commonDb-573409be.js":"node_modules/mermaid/dist/commonDb-573409be.js","d3":"node_modules/d3/src/index.js","@braintree/sanitize-url":"node_modules/@braintree/sanitize-url/dist/index.js","./utils-d622194a.js":"node_modules/mermaid/dist/utils-d622194a.js","stylis":"node_modules/stylis/dist/stylis.mjs","dompurify":"node_modules/dompurify/dist/purify.js","lodash-es/isEmpty.js":"node_modules/lodash-es/isEmpty.js","dayjs":"node_modules/dayjs/dayjs.min.js","khroma":"node_modules/khroma/dist/index.js","lodash-es/memoize.js":"node_modules/lodash-es/memoize.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/c4Diagram-44c43e89.1782ecaa.js.map